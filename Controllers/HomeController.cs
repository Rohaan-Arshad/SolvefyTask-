...
namespace Solvefy_Task.Controllers
{
    ...
    {
        private readonly solvefyContext _context;

        public HomeController(solvefyContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return _context.Products != null ? 
                          ...
                          Problem("Entity set 'solvefyContext.Products'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'solvefyContext.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
